...
export class AddGameTables1782824906349 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "game_templates" ("id" text NOT NULL, "config" jsonb, "path" text NOT NULL, CONSTRAINT "PK_82ddaa337d0011639ee19cfa8dc" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "games" ADD CONSTRAINT "FK_4cd1b2a3016fba918f1b92faa4a" FOREIGN KEY ("template_id") REFERENCES "game_templates"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "games" DROP CONSTRAINT "FK_4cd1b2a3016fba918f1b92faa4a"`,
    );
